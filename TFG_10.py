...
#TEST01
for k in range(len(Test01)):
    wi = (wiAnt * (1-(1/landa))) + (Test01[k]/landa)
    wiAnt = wi
    Test01Wi.append(wi)

print("TEST 01 - WI:", len(Test01Wi))

#TEST02
for k in range(len(Test02)):
    wi = (wiAnt * (1-(1/landa))) + (Test02[k]/landa)
    wiAnt = wi
    Test02Wi.append(wi)

print("TEST 02 - WI:", len(Test01Wi))

#TEST03
for k in range(len(Test03)):
    wi = (wiAnt * (1-(1/landa))) + (Test03[k]/landa)
    wiAnt = wi
    Test03Wi.append(wi)

print("TEST 01 - WI:", len(Test03Wi))

#TEST04
for k in range(len(Test04)):
    wi = (wiAnt * (1-(1/landa))) + (Test04[k]/landa)
    wiAnt = wi
    Test04Wi.append(wi)

print("TEST 04 - WI:", len(Test04Wi))

#TEST05
for k in range(len(Test05)):
    wi = (wiAnt * (1-(1/landa))) + (Test05[k]/landa)
    wiAnt = wi
    Test05Wi.append(wi)

print("TEST 05 - WI:", len(Test05Wi))

#TEST06
for k in range(len(Test06)):
    wi = (wiAnt * (1-(1/landa))) + (Test06[k]/landa)
    wiAnt = wi
    Test06Wi.append(wi)

print("TEST 06 - WI:", len(Test06Wi))

#TEST07
for k in range(len(Test07)):
    wi = (wiAnt * (1-(1/landa))) + (Test07[k]/landa)
    wiAnt = wi
    Test07Wi.append(wi)

print("TEST 07 - WI:", len(Test07Wi))

#TEST08
for k in range(len(Test08)):
    wi = (wiAnt * (1-(1/landa))) + (Test08[k]/landa)
    wiAnt = wi
    Test08Wi.append(wi)

print("TEST 08 - WI:", len(Test08Wi))

#TEST09
for k in range(len(Test09)):
    wi = (wiAnt * (1-(1/landa))) + (Test09[k]/landa)
    wiAnt = wi
    Test09Wi.append(wi)

print("TEST 09 - WI:", len(Test09Wi))

#TEST10
for k in range(len(Test10)):
    wi = (wiAnt * (1-(1/landa))) + (Test10[k]/landa)
    wiAnt = wi
    Test10Wi.append(wi)

print("TEST 10 - WI:", len(Test10Wi))
